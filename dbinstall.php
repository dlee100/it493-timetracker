...
if ($_POST) {
  ...
  if ($_POST["convert1340to1485"]) {
    ...
    ttExecute("ALTER TABLE tt_users CHANGE u_vacation_balance vacation_balance float(6,2) NOT NULL default '0.00'");
  ...
  if ($_POST["convert1485to1579"]) {
    ...
    ttExecute("ALTER TABLE tt_user_project_binds CHANGE ub_vacation_balance vacation_balance float(6,2) NOT NULL default '0.00'");
  ...
  if ($_POST["convert11797to11900"]) {
    ...
    ttExecute("ALTER TABLE `tt_users` ADD COLUMN `vacation_balance` float(6,2) default NULL after `rate`");
    ttExecute("ALTER TABLE `tt_users` ADD COLUMN `quota_percent` float(6,2) default NULL after `vacation_balance`");
    ttExecute("ALTER TABLE `tt_users` ADD COLUMN `sicktime_balance` float(6,2) default NULL after `rate`");
    ttExecute("ALTER TABLE `tt_users` ADD COLUMN `quota_percent` float(6,2) default NULL after `sicktime_balance`");
