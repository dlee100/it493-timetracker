...
class ttUserHelper {
  ...
  static function insert($fields, $hash = true) {
    ...
    $sql = "insert into tt_users (name, login, password, group_id, org_id, role_id, client_id, rate, vacation_balance, sicktime_balance, vacation_accrual_rate, sicktime_accrual_rate, quota_percent, email, created, created_ip, created_by $status_f) values (".
  ...
  static function update($user_id, $fields) {
    ...
    $parts = ltrim($login_part.$pass_part.$name_part.$role_part.$client_part.$rate_part.$vacation_balance_part.$sicktime_balance_part.$vacation_accrual_rate_part.$sicktime_accrual_rate_part.$quota_percent_part.$email_part.$modified_part.$status_part, ',');
