...
class ttUser {
  ...
  function getUserDetails($user_id) {
    ...
    $sql =  "select u.id, u.name, u.login, u.role_id, u.client_id, u.status, u.rate, u.vacation_balance, u.sicktime_balance, u.vacation_accrual_rate, u.sicktime_accrual_rate, u.quota_percent, u.email from tt_users u".
